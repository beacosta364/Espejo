...
public class GestionarVentaForm extends JFrame {
    ...
    public GestionarVentaForm() {
        ...
        gestionarVentaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                gestionarVenta.gestionarVenta(codProducto, cantidad, codVendedor, codCliente);
            }
        });
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new GestionarVentaForm().setVisible(true);
            }
        });
    }
}
